...
export const metadata: Metadata = {
  title: "Curso de Cerrajería Online",
  description:
      ...
      <head>
        <Script id="microsoft-clarity" strategy="afterInteractive">
          {`
            ...
            })(window, document, "clarity", "script", "vbbelho578");
          `}
        </Script>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2338003480044925&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </head>
